...
<body>
    ...
    <div class="container">
        ...
        <br />
            ...
            <input value="<?php echo $raca?>" type="text" id="racapet" name="racapet" class="form-control" placeholder="Raça" /><br />
            <input value="<?php echo $idade?>" type="number" id="idadepet" name="idadepet" class="form-control" placeholder="Idade" /><br />
            <input value="<?php echo $inf_ad?>" type="text" id="inf_ad" name="inf_ad" class="form-control" placeholder="Informações Adicionais" /><br />
            <!--<textarea value="<?php echo $inf_ad?>" name="message" id="inf_ad" name="inf_ad" class="form-control" placeholder="Informações Adicionais"></textarea><br />-->
